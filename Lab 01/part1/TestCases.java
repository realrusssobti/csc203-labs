...
public class TestCases
{
   ...
   public void testSimpleArray3()
   {
      ...
      assertArrayEquals(
         new int[] {1, 4, 9, 16},
         SimpleArray.squareAll(new int[] {1, 2, 3, 4}));
   }
   ...
   public void testSimpleList2()
   {
      ...
      /* TO DO: Add a new test case. */
      List<Integer> input =
         new LinkedList<Integer>(Arrays.asList(new Integer[] {7, 5}));
      List<Integer> expected =
         new ArrayList<Integer>(Arrays.asList(new Integer[] {49, 25}));
   }
   ...
   public void testBetterLoop3()
   {
      ...
      assertTrue(BetterLoop.contains(new int[] {7, 5, 2, 4}, 3));
   }

...
public class LogAnalyzer
{
   ...
   public List<Session> userSessions = new ArrayList<Session>();
      ...
      )
   {
     // create a View object
      View currentView = new View(words[VIEW_PRODUCT_ID], Integer.parseInt(words[VIEW_PRICE]));
      // add to the Session's list of views
